...
export class WebService {
  ...
  getHomeFeed() {
    ...
    return this.http.get('http://localhost:5000/api/home', { headers: headers });
  }
  ...
  getSinglePost(groupId : string, postId : string) {
    ...
    return this.http.get(`http://localhost:5000/api/groups/${groupId}/${postId}`, { headers: headers });
  }
  ...
  getUserGroups() {
    ...
    return this.http.get('http://localhost:5000/api/get_user_groups', { headers: headers });
  }
  ...
  getGroupById(id: string) {
    ...
    return this.http.get(`http://localhost:5000/api/groups/${id}`, { headers });
  }
  ...
  return this.http.post("http://localhost:5000/api/create_post", formData, {headers: headers});
  }
  ...
  createGroup(groupData : any) {
    ...
    return this.http.post('http://localhost:5000/api/create_group', formData, { headers });
  }
  ...
  editGroup(id: string, groupData: any) {
    ...
    return this.http.put(`http://localhost:5000/api/groups/${id}/settings/edit_group`, formData, { headers });
  }
  ...
  deleteGroup(id: string) {
    ...
    return this.http.delete(`http://localhost:5000/api/groups/${id}/settings/delete_group`, { headers });
  }
  ...
  editPost(groupId: string, postId: string, postData: any) {
    ...
    return this.http.delete(`http://localhost:5000/api/groups/${groupId}/${postId}/delete_post`, { headers });
  }
  ...
  searchGroupByName(name: string) {
    const token = localStorage.getItem('token');
    const headers = new HttpHeaders().set('x-access-token', token || '');
    return this.http.get(`http://localhost:5000/api/search_for_groups/group_name/${name}`, {headers});
  }
  ...
  searchGroupByCategory(category: string) {
    const token = localStorage.getItem('token');
    const headers = new HttpHeaders().set('x-access-token', token || '');
    return this.http.get(`http://localhost:5000/api/search_for_groups/category/${category}`, {headers});
  }
  ...
  addComment(groupId: string, postId: string, text: string) {
    ...
    return this.http.post(
      `http://localhost:5000/api/groups/${groupId}/${postId}/add_comment`,
      formData,
      { headers }
    );
  }
  ...
  updateComment(groupId: string, postId: string, commentId: string, text: string) {
    ...
    return this.http.put(
      `http://localhost:5000/api/groups/${groupId}/${postId}/${commentId}/edit`,
      formData,
      { headers }
    );
  }
  ...
  removeComment(groupId: string, postId: string, commentId: string) {
    ...
    return this.http.delete(
      `http://localhost:5000/api/groups/${groupId}/${postId}/${commentId}/delete`,
      { headers }
    );
  }
  ...
  joinGroup(groupId: string) {
    ...
    return this.http.put(`http://localhost:5000/api/${groupId}/join`, {}, { headers });
  }
  ...
  getJoinRequests(groupId: string) {
    const headers = new HttpHeaders().set('x-access-token', localStorage.getItem('token') || '');
    return this.http.get(`http://localhost:5000/api/groups/${groupId}/requests_to_join`, { headers });
  }

  // Accept join request
  acceptRequest(groupId: string, requestId: string) {
    const headers = new HttpHeaders().set('x-access-token', localStorage.getItem('token') || '');
    return this.http.put(`http://localhost:5000/api/groups/${groupId}/requests_to_join/${requestId}/accepted`, {}, { headers });
  }

  // Reject join request
  rejectRequest(groupId: string, requestId: string) {
    const headers = new HttpHeaders().set('x-access-token', localStorage.getItem('token') || '');
    return this.http.put(`http://localhost:5000/api/groups/${groupId}/requests_to_join/${requestId}/rejected`, {}, { headers });
  }
  ...
  leaveGroup(groupId: string) {
    ...
    return this.http.put(`http://localhost:5000/api/groups/${groupId}/leave`, {}, { headers });
  }
